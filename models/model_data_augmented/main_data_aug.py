...
def main():
    ...
    usure_train_list  = 'export_michelin_v1/data_aug/image_names_train.txt'
    usure_val_list    = 'export_michelin_v1/data_aug/image_names_val.txt'
    usure_test_list   = 'export_michelin_v1/data_aug/image_names_test.txt'
    usure_images_dir  = 'export_michelin_v1/combined'
